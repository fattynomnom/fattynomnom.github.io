...
</code></pre><p>After this is done on the backend, I logged into my frontend application and queried <code class="">getAllUsers</code>. On top of the 200 status code and the data response, I checked my backend terminal to find this logged:</p><p><img src="`+ne+'" alt="Console log"></p><p>So it worked!</p><p>I’m aware that I’m not actually doing anything with the user’s email yet, but now that I have the base setup, I can actually start setting up the tables and models I need for the frontend to use, so that’s what I’ll actually be doing next.</p><p>I’m not too sure if I’ll be updating this space since I’ve actually gotten everything setup, and now its just the tedious task of setting up tables, schema and data, but I’ll keep in mind to update whenever I learn something new.</p><p>I’ve committed my progress to <a href="https://github.com/fattynomnom/itrack-expressjs">this repo</a>.</p>',28),de=[ie],ce={title:"Adding user email to Auth0 token claims",date:"16/11/23"},le=d({__name:"17th_nov_23",setup(t,{expose:e}){return e({frontmatter:{title:"Adding user email to Auth0 token claims",date:"16/11/23"},excerpt:void 0}),(n,r)=>(o(),a("div",re,de))}}),pe={xmlns:"http://www.w3.org/2000/svg",fill:"none",stroke:"currentColor","stroke-width":"1.5",class:"w-6 h-6",viewBox:"0 0 24 24"},he=i("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"m19.5 8.25-7.5 7.5-7.5-7.5"},null,-1),ue=[he];function ge(t,e){return o(),a("svg",pe,[...ue])}const me={render:ge},fe=t=>(_("data-v-ce92bf74"),t=t(),b(),t),we={class:"divide-y p-10 md:px-28 lg:py-36 h-full lg:overflow-y-auto"},ye=c('<section data-v-ce92bf74><h1 data-v-ce92bf74>Hey there!</h1><p data-v-ce92bf74> I&#39;m a part time software engineer and full time cat person who likes problem solving and puzzles. </p><p data-v-ce92bf74> I don&#39;t have any fancy repositories for you to see (I&#39;m sure you can understand as a software developer, most of our client works are proprietary), though you can still head over to my <a href="https://github.com/fattynomnom" data-v-ce92bf74>Github</a> to view my personal projects I&#39;m working on when I have the time! </p><p data-v-ce92bf74> I&#39;m a huge advocate for Typescript, object-oriented programming and clean coding practices (DRY, SOLID). I know writing it is a pain, but reading clean code is <i data-v-ce92bf74>*chefs kiss*</i>. Do I sit back sometimes and admire clean code structures? Yes, yes I do. </p><p data-v-ce92bf74> My hobbies are gardening, reading mangas, watching movies and starting 1001 coding projects that I don&#39;t finish. </p><p data-v-ce92bf74> I&#39;m trying to hold myself accountable by creating this site to document my learning process. Hopefully I&#39;ll be able to learn and update this space as much as possible (when life, work and cats doesn&#39;t get in the way). </p><p data-v-ce92bf74> Just in case you&#39;re curious, this site was made with VueJs and TailwindCss (both of which I <i data-v-ce92bf74>think</i> I&#39;m a master at). </p></section>',1),_e=fe(()=>i("h1",null,"What I'm learning",-1)),be=["onClick"],Ie={class:"text-sm text-gray-400"},xe=d({__name:"HomeView",setup(t){const e=h([{frontmatter:ce,component:le,displayed:!1},{frontmatter:Z,component:ee,displayed:!1},{frontmatter:z,component:V,displayed:!1},{frontmatter:H,component:J,displayed:!1},{frontmatter:C,component:E,displayed:!1},{frontmatter:S,component:T,displayed:!1}]);return(n,r)=>(o(),a("main",we,[ye,i("section",null,[_e,(o(!0),a(u,null,g(e.value,s=>(o(),a("div",{key:s.frontmatter.title,class:"space-y-5 p-5 md:p-10 rounded-lg bg-gray-50 overflow-hidden"},[i("div",{class:"flex items-center justify-between cursor-pointer space-x-5",onClick:ke=>s.displayed=!s.displayed},[i("div",null,[i("p",Ie,l(s.frontmatter.date),1),i("h2",null,l(s.frontmatter.title),1)]),p(f(me),{class:m(["w-5 h-5 text-gray-500",{"rotate-180":s.displayed}])},null,8,["class"])],8,be),p(y,null,{default:w(()=>[s.displayed?(o(),I(x(s.component),{key:0})):v("",!0)]),_:2},1024)]))),128))])]))}});const ve=(t,e)=>{const n=t.__vccOpts||t;for(const[r,s]of e)n[r]=s;return n},qe=ve(xe,[["__scopeId","data-v-ce92bf74"]]);export{qe as default};
