...
</code></pre><p>And thats it! It seems simple but I spent a long time trying to find a way to “unit” test my resolvers. Like should I be using Supertest? Should I start the Express server? How do I start the Apollo server for testing? But eventually I found my way here and what works for me.</p><p>You can find my implementation in <a href="https://github.com/fattynomnom/itrack-expressjs">this repo</a>.</p>`,18)])))}});export{u as default,d as excerpt,c as frontmatter};
