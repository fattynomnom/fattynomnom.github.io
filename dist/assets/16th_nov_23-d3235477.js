...
</code></pre><p>I finished up by adding my generated types file to my Eslint ignore list as well as my <code class="">.gitignore</code>.</p><p>I’ve committed my changes to <a href="https://github.com/fattynomnom/itrack-expressjs">this repo</a>.</p><p>Ok now onto the next thing: adding user details to token claims.</p>`,18),c=[a],g={title:"Generate typings from GraphQL schema",date:"16/11/23"},m="",h=t({__name:"16th_nov_23",setup(p,{expose:e}){return e({frontmatter:{title:"Generate typings from GraphQL schema",date:"16/11/23"},excerpt:void 0}),(i,d)=>(o(),n("div",r,c))}});export{h as default,m as excerpt,g as frontmatter};
