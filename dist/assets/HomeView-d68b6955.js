...
</code></pre><p>I finished up by adding my generated types file to my Eslint ignore list as well as my <code class="">.gitignore</code>.</p><p>I’ve committed my changes to <a href="https://github.com/fattynomnom/itrack-expressjs">this repo</a>.</p><p>Ok now onto the next thing: adding user details to token claims.</p>`,18),X=[Y],Z={title:"Generate typings from GraphQL schema",date:"16/11/23"},ee=d({__name:"16th_nov_23",setup(t,{expose:e}){return e({frontmatter:{title:"Generate typings from GraphQL schema",date:"16/11/23"},excerpt:void 0}),(n,r)=>(s(),a("div",W,X))}}),te={xmlns:"http://www.w3.org/2000/svg",fill:"none",stroke:"currentColor","stroke-width":"1.5",class:"w-6 h-6",viewBox:"0 0 24 24"},oe=i("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"m19.5 8.25-7.5 7.5-7.5-7.5"},null,-1),se=[oe];function ae(t,e){return s(),a("svg",te,[...se])}const ne={render:ae},re=t=>(x("data-v-2ed90465"),t=t(),I(),t),ie={class:"divide-y p-10 md:px-28 lg:py-36 h-full lg:overflow-y-auto"},de=c('<section data-v-2ed90465><h1 data-v-2ed90465>Hey there!</h1><p data-v-2ed90465> I&#39;m a part time software engineer and full time cat person who likes problem solving and puzzles. </p><p data-v-2ed90465> I don&#39;t have any fancy repositories for you to see (I&#39;m sure you can understand as a software developer, most of our client works are proprietary), though you can still head over to my <a href="https://github.com/fattynomnom" data-v-2ed90465>Github</a> to view my personal projects I&#39;m working on when I have the time! </p><p data-v-2ed90465> I&#39;m a huge advocate for Typescript, object-oriented programming and clean coding practices (DRY, SOLID). I know writing it is a pain, but reading clean code is <i data-v-2ed90465>*chefs kiss*</i>. Do I sit back sometimes and admire clean code structures? Yes, yes I do. </p><p data-v-2ed90465> My hobbies are gardening, reading mangas, watching movies and starting 1001 coding projects that I don&#39;t finish. </p><p data-v-2ed90465> I&#39;m trying to hold myself accountable by creating this site to document my learning process. Hopefully I&#39;ll be able to learn and update this space as much as possible (when life, work and cats doesn&#39;t get in the way). </p><p data-v-2ed90465> Just in case you&#39;re curious, this site was made with VueJs and TailwindCss (both of which I <i data-v-2ed90465>think</i> I&#39;m a master at). </p></section>',1),ce=re(()=>i("h1",null,"What I'm learning",-1)),le=["onClick"],pe={class:"text-sm text-gray-400"},he=d({__name:"HomeView",setup(t){const e=h([{frontmatter:Z,component:ee,displayed:!1},{frontmatter:F,component:V,displayed:!1},{frontmatter:J,component:M,displayed:!1},{frontmatter:E,component:C,displayed:!1},{frontmatter:S,component:T,displayed:!1}]);return(n,r)=>(s(),a("main",ie,[de,i("section",null,[ce,(s(!0),a(u,null,g(e.value,o=>(s(),a("div",{key:o.frontmatter.title,class:"space-y-5 p-5 md:p-10 rounded-lg bg-gray-50 overflow-hidden"},[i("div",{class:"flex items-center justify-between cursor-pointer space-x-5",onClick:ge=>o.displayed=!o.displayed},[i("div",null,[i("p",pe,l(o.frontmatter.date),1),i("h2",null,l(o.frontmatter.title),1)]),p(f(ne),{class:m(["w-5 h-5 text-gray-500",{"rotate-180":o.displayed}])},null,8,["class"])],8,le),p(y,null,{default:w(()=>[o.displayed?(s(),_(b(o.component),{key:0})):v("",!0)]),_:2},1024)]))),128))])]))}});const ue=(t,e)=>{const n=t.__vccOpts||t;for(const[r,o]of e)n[r]=o;return n},fe=ue(he,[["__scopeId","data-v-2ed90465"]]);export{fe as default};
