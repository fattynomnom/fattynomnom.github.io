import{d as o,c as a,f as s,o as n}from"./index-5a3f0592.js";const i="/assets/15th_nov_23_1-c2eda73f.png",r="/assets/15th_nov_23_2-ff2f2715.png",d={class:"markdown-body"},h={title:"Implementing Auth0 in NextJs",date:"15/11/23"},u="",g=o({__name:"15th_nov_23",setup(l,{expose:t}){return t({frontmatter:{title:"Implementing Auth0 in NextJs",date:"15/11/23"},excerpt:void 0}),(c,e)=>(n(),a("div",d,e[0]||(e[0]=[s('<p>Initially I had implemented Firebase authentication for my <a href="https://github.com/fattynomnom/itrack-nextjs">NextJs project</a>, but if you saw my previous update, I decided to go ahead with Auth0 instead.</p><p>For this, I’ll be using the <a href="https://github.com/auth0/nextjs-auth0#page-router">nextjs-auth0 package</a>.</p><h1>Configure Auth0 application</h1><p>First, I followed <a href="https://github.com/auth0/nextjs-auth0#auth0-configuration">the docs</a> and updated my application’s Allowed Callback URLs and Allowed Logout URLs in the Auth0 dashboard.</p><p><img src="'+i+`" alt="Configure allowed Auth0 URLs"></p><p>Something that I was REALLY confused about this step was the Allowed Callback URLs. I thought that I had to enter the URL that I wanted Auth0 to redirect to after login was completed. But it wasn’t the case, I tried it and got an error after logging in. I’ll explain how to ACTUALLY perform the redirect later.</p><h1>Configure package in NextJs</h1><p>I updated the env variables required for the package to work:</p><pre><code class="">// .env
