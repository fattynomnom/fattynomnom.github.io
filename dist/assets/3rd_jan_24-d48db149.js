import{d as t,c as o,f as s,o as a}from"./index-5a3f0592.js";const r="/assets/3rd_jan_24_1-800dc83c.png",i={class:"markdown-body"},p={title:"Adding middlewares to GraphQL resolvers",date:"3/1/24"},h="",m=t({__name:"3rd_jan_24",setup(d,{expose:n}){return n({frontmatter:{title:"Adding middlewares to GraphQL resolvers",date:"3/1/24"},excerpt:void 0}),(l,e)=>(a(),o("div",i,e[0]||(e[0]=[s(`<p>It’s been awhile, but I had very good excuse: work and more work. The holidays season has been STRESSFUL to say the least.</p><p>Anyway, I got to work adding more more queries and mutations, but before long, it started looking like this:</p><pre><code class="">// src/Resolvers.ts
...
</code></pre><p>Now I can update my <code class="">Resolvers</code> file to remove the parts where I’m throwing a 401 error.</p><p>This is the result when testing it:</p><p><img src="`+r+'" alt="Apollo sandbox testing result"></p><p>As usual, you can find the full functioning code <a href="https://github.com/fattynomnom/itrack-expressjs">here</a>.</p><h1>Final thoughts</h1><p>This implementation isn’t as intuitive as I’d like it to be. What if a resolver needs multiple middlewares? I can foresee my middleware file easily becoming very complex very quickly, as opposed to in ExpressJS, where you can easily chain middlewares together using <code class="">app.use()</code>.</p><p>But maybe I’m being pessimistic and there is a clean, intuitive way to chain middlewares together, I just haven’t found it yet. Either way, I’ll update this space again with my findings!</p>',18)])))}});export{m as default,h as excerpt,p as frontmatter};
