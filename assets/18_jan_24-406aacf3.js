import{d as s,c as o,f as r,o as n}from"./index-5a3f0592.js";const a={class:"markdown-body"},d={title:"GraphQL + ExpressJS clean architectural pattern",date:"19/1/24"},c="",h=s({__name:"18_jan_24",setup(i,{expose:t}){return t({frontmatter:{title:"GraphQL + ExpressJS clean architectural pattern",date:"19/1/24"},excerpt:void 0}),(l,e)=>(n(),o("div",a,e[0]||(e[0]=[r(`<p>So this was my initial “pattern” (or non-pattern really):</p><pre><code class="">| src
    - Resolvers.ts
    - TypeDefs.ts
    - index.ts
